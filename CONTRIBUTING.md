...
VoiceGen is meant to help AMD GPU users run VoxCPM2 voice generation through ROCm. The current verified setup is an RX 7900 XTX on Windows + WSL2 + Ubuntu 22.04 + ROCm 7.2. Other AMD cards need community testing.
